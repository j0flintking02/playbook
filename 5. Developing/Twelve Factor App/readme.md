...
Multiple apps sharing the same code is a violation of twelve-factor. The solution here is to factor shared code into libraries which can be included through the dependency manager. In our case, we used a [shared repo](https://github.com/Mookh/micro-shared) and git submodules is used to include shared code.
...
```
{
  ...
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Mookh/micro-authorization-service.git"
  },
  "author": "",
  "license": "ISC",
  "bugs": {
    "url": "https://github.com/Mookh/micro-authorization-service/issues"
  },
  "homepage": "https://github.com/Mookh/micro-authorization-service#readme",
  "dependencies": {
    "bluebird": "^3.4.0",
